...
if mods["space-age"] then
  khaoslib_ammo.copy("rocket", "mds-ballistic-tungsten-missile")
    :set {
      order = "d[rocket-launcher]-e[mds]-c[tungsten]",
        ...
        :replace_action(function(action)
          ...
          return khaoslib_trigger_item:load(action)
            :replace_action_delivery(function(delivery)
              ...
              type = "artillery",
              projectile = "mds-ballistic-artillery-projectile-tungsten",
